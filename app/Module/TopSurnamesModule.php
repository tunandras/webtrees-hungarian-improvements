...
class TopSurnamesModule extends AbstractModule implements ModuleBlockInterface {
	...
	public function getBlock($block_id, $template = true, $cfg = array()) {
		...
		// has to copied here otherwise user doesn't understand why the number differs from the 
		// expected (input of add and remove surnames may also be copied to make this module 
		// indenpendent from module statistics). The data of original input field is still used 
		// in the bottom of the statistics module
